...
-- 9.Which top 10 locations have the most people fully vaccinated
-- The Result is:
-- Asia - 3 151 539 386
-- India - 831 238 996
-- Europe - 488 800 282
...
-- 10.Which locations have zero people fully vaccinated
-- The Result is:
-- Nicaragua
-- Tonga
-- Saint Helena
...
-- 11.Create View with locations, total deaths and total cases
-- The Result is:

CREATE VIEW [Total Deaths and Total Cases per Location]
AS
...
SELECT * 
FROM [Total Deaths and Total Cases per Location]


-- 12.Create View with people fully vaccinated per location
-- The Result is:

CREATE VIEW [People fully vaccinated per Location]
AS
SELECT location, people_fully_vaccinated
FROM Covid19
WHERE date = '2022-03-31'
